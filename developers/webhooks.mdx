...
Webhooks push events from EzyText to your own URL in real time — for example, when a
...
```http
X-EzyText-Signature: t=<unix>,v1=<hex-hmac-sha256>
X-EzyText-Timestamp: <unix>
X-EzyText-Event: <event.name>
X-EzyText-Delivery: <delivery-id>
```
...
<AccordionGroup>
  <Accordion title="Signature verification fails">
    ...
    secret using HMAC-SHA256, and compare to the `v1` value in `X-EzyText-Signature`.
  </Accordion>
